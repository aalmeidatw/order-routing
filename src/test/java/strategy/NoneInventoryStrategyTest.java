...
public class NoneInventoryStrategyTest {
    private NoneInventoryStrategy noneInventoryStrategy = new NoneInventoryStrategy();
    ...
    public void shouldReturnSomeInventoryList() throws Exception {
        ...
        List<InventoryItem> actual = noneInventoryStrategy.executeStrategy(asList(BRAZIL_KEYBOARD_2,
                FRANCE_MOUSE_2));
