...
public class CapacityListMapTest {
    ...
    private static String BRAZIL_WAREHOUSE = "BRAZIL";
    ...
    public void shouldReturnTrueWhenCapacityIsMoreThanZero() throws Exception {
        assertTrue(capacityListMap.isMoreThanZero(BRAZIL_WAREHOUSE));
    }

    @Test
    public void shouldReturnMaxCapacityWhenWarehouseNameIsPassed() throws Exception {
        assertThat(capacityListMap.getProductQuantity(BRAZIL_WAREHOUSE), is(BRAZIL_CAPACITY));
    }

    @Test
    public void shouldInsertNewValueInCapacityMapWhenWarehouseNameIsPassed() throws Exception {
        capacityListMap.updateCapacityQuantity(BRAZIL_WAREHOUSE, BRAZIL_NEW_CAPACITY);
        assertThat(capacityListMap.getProductQuantity(BRAZIL_WAREHOUSE), is(BRAZIL_NEW_CAPACITY));
    }
}